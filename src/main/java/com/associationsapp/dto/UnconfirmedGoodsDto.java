...
@Data
public class UnconfirmedGoodsDto {
    private long id ;
    private String name ;
    private long amount ;
    ...
    public UnconfirmedGoodsDto(long id ,String name, long amount,String donor_email , String event_title ){
